 ...
 * </p>
 * <ul>
 *   <li>{@link lu.svv.offline.tempsy.impl.BoundaryImpl#getOrdinal <em>Ordinal</em>}</li>
 *   <li>{@link lu.svv.offline.tempsy.impl.BoundaryImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link lu.svv.offline.tempsy.impl.BoundaryImpl#getTimeDistance <em>Time Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoundaryImpl extends MinimalEObjectImpl.Container implements Boundary {
	...
	protected EClass eStaticClass() {
		return TemPsyPackage.Literals.BOUNDARY;
	}
	...
	public void setOrdinal(int newOrdinal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemPsyPackage.BOUNDARY__ORDINAL, oldOrdinal, ordinal));
	}
	...
	public NotificationChain basicSetEvent(EventRepresentation newEvent, NotificationChain msgs) {
		...
		event = newEvent;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemPsyPackage.BOUNDARY__EVENT, oldEvent, newEvent);
	...
	public void setEvent(EventRepresentation newEvent) {
		if (newEvent != event) {
			...
			if (event != null)
				msgs = ((InternalEObject)event).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemPsyPackage.BOUNDARY__EVENT, null, msgs);
			if (newEvent != null)
				msgs = ((InternalEObject)newEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemPsyPackage.BOUNDARY__EVENT, null, msgs);
			msgs = basicSetEvent(newEvent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemPsyPackage.BOUNDARY__EVENT, newEvent, newEvent));
	}
	...
	public NotificationChain basicSetTimeDistance(TimeDistance newTimeDistance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemPsyPackage.BOUNDARY__TIME_DISTANCE, oldTimeDistance, newTimeDistance);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTimeDistance(TimeDistance newTimeDistance) {
		if (newTimeDistance != timeDistance) {
			...
			if (timeDistance != null)
				msgs = ((InternalEObject)timeDistance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemPsyPackage.BOUNDARY__TIME_DISTANCE, null, msgs);
			if (newTimeDistance != null)
				msgs = ((InternalEObject)newTimeDistance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemPsyPackage.BOUNDARY__TIME_DISTANCE, null, msgs);
			msgs = basicSetTimeDistance(newTimeDistance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemPsyPackage.BOUNDARY__TIME_DISTANCE, newTimeDistance, newTimeDistance));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TemPsyPackage.BOUNDARY__EVENT:
				return basicSetEvent(null, msgs);
			case TemPsyPackage.BOUNDARY__TIME_DISTANCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TemPsyPackage.BOUNDARY__ORDINAL:
				return getOrdinal();
			case TemPsyPackage.BOUNDARY__EVENT:
				return getEvent();
			case TemPsyPackage.BOUNDARY__TIME_DISTANCE:
