/**
 */
package lu.svv.offline.check.util;

import lu.svv.offline.check.*;
...
public class CheckAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link lu.svv.offline.check.Monitor <em>Monitor</em>}'.
	 * <!-- begin-user-doc -->
