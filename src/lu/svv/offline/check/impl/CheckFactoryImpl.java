...
public class CheckFactoryImpl extends EFactoryImpl implements CheckFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CheckPackage.MONITOR: return createMonitor();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case CheckPackage.VIOLATION_TYPE:
				return createViolationTypeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case CheckPackage.VIOLATION_TYPE:
				return convertViolationTypeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public ViolationType createViolationTypeFromString(EDataType eDataType, String initialValue) {
		ViolationType result = ViolationType.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertViolationTypeToString(EDataType eDataType, Object instanceValue) {
